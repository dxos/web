...
*There are the 2 main components we need to pay atention to:*
...
In a real-world scenario, `TestFrameContainer` will actually be an app. We usually call them `Host Apps`.
