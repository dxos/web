...
Circling back to your domain, if you haven't claimed it yet, now you can do so. If you missed that step you'll need to go through [Account Setup](./account-setup) before continuing.
